...
<!-- Main Section Begins -->
  	<section id="top">
  	  ...
  	  <?php
  	    ...
  	    $result = mysql_query("SELECT * FROM gym WHERE id='9'") or die ('Error: '.mysql_error ());
		  ...
		  <div id="example">
			<div id="slides">
				<div class="slides_container">
					<img src="images/lady-1.jpg" width="570" height="270" alt="Slide 1"></a>
					<img src="images/lady-2.jpg" width="570" height="270" alt="Slide 2"></a>
					<img src="images/lady-3.jpg" width="570" height="270" alt="Slide 3"></a>
					<img src="images/lady-4.jpg" width="570" height="270" alt="Slide 4"></a>
				</div>
