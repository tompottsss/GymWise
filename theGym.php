...
<!-- Main Section Begins -->
  	<section id="top">
  	  ...
  	  <?php
  	    ...
  	    $result = mysql_query("SELECT * FROM gym WHERE id='3'") or die ('Error: '.mysql_error ());
		  ...
		  <div id="example">
			<div id="slides">
				<div class="slides_container">
					<img src="images/gym-facilities.jpg" width="570" height="270" alt="Slide 1"></a>
					<img src="images/gym-cardio.jpg" width="570" height="270" alt="Slide 2"></a>
					<img src="images/gym-gym.jpg" width="570" height="270" alt="Slide 3"></a>
					<img src="images/gym-machine.jpg" width="570" height="270" alt="Slide 4"></a>
					<img src="images/gym-weights.jpg" width="570" height="270" alt="Slide 5"></a>
				</div>
