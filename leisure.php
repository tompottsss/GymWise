...
<!-- Main Section Begins -->
  	<section id="top">
  	  ...
  	  <?php
  	    ...
  	    $result = mysql_query("SELECT * FROM gym WHERE id='4'") or die ('Error: '.mysql_error ());
		  ...
		  <div id="example">
			<div id="slides">
				<div class="slides_container">
					<img src="images/leisure-spin.jpg" width="570" height="270" alt="Slide 1"></a>
					<img src="images/leisure-gym.jpeg" width="570" height="270" alt="Slide 2"></a>
					<img src="images/leisure.jpg" width="570" height="270" alt="Slide 3"></a>
				</div>
