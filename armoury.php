...
<!-- Main Section Begins -->
  	<section id="top">
  	  ...
  	  <?php
  	    ...
  	    $result = mysql_query("SELECT * FROM gym WHERE id='5'") or die ('Error: '.mysql_error ());
		  ...
		  <div id="example">
			<div id="slides">
				<div class="slides_container">
					<img src="images/armoury-gym.jpg" width="570" height="270" alt="Slide 1"></a>
					<img src="images/armoury-bench.jpg" width="570" height="270" alt="Slide 2"></a>
					<img src="images/armoury-weights.jpg" width="570" height="270" alt="Slide 3"></a>
					<img src="images/armoury-machine.jpg" width="570" height="270" alt="Slide 4"></a>
					<img src="images/armoury-stack.jpg" width="570" height="270" alt="Slide 5"></a>
				</div>
