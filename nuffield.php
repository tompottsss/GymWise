...
<!-- Main Section Begins -->
  	<section id="top">
  	  ...
  	  <?php
  	    ...
  	    $result = mysql_query("SELECT * FROM gym WHERE id='7'") or die ('Error: '.mysql_error ());
		  ...
		  <div id="example">
			<div id="slides">
				<div class="slides_container">
					<img src="images/nuffield-pool.jpg" width="570" height="270" alt="Slide 1"></a>
					<img src="images/nuffield-run.jpg" width="570" height="270" alt="Slide 2"></a>
					<img src="images/nuffield-studio.jpg" width="570" height="270" alt="Slide 3"></a>
					<img src="images/nuffield-spin.jpg" width="570" height="270" alt="Slide 4"></a>
				</div>
